...
def noise(
    ...
    Args:
        ...
        amount (float, optional): _description_. Defaults to 0.05.
        noise_type (str, optional): Sets the type of generated noise. Defaults to "gaussian". [ GAUSSIAN | SALT_PEPPER | SHOT | UNIFORM | 50_PER_CENT | PERLIN | BLUE | PINK | WHITE ].
        size (Optional[float], optional): For noise types that support scale/size (e.g., Perlin), this sets the scale factor. Defaults to 1. Ignored by other noise types.
